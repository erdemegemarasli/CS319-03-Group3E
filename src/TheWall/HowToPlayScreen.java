...
public class HowToPlayScreen extends SimplePanel {
    ...
    public HowToPlayScreen() {
        ...
        JLabel info2 = new JLabel( "Rotate the choosen wall with right click of mouse");
        JLabel info3 = new JLabel(" and place the wall with left click. The red");
        JLabel info4 = new JLabel( "knights needed to kept outside, the blue knights and ");
        JLabel info41 = new JLabel("high towers needed to remain within the walls.");
        ...
        info41.setForeground(Color.GREEN);
        info5.setForeground(Color.GREEN);
